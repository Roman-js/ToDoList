...
export const setTasks = (tasks, todolistId) => ({type: SET_TASKS, todolistId, tasks})
export const changeTitleTodolist = (todolistId, newTitle) => ({type: CHANGE_TITLE_TODOLIST, todolistId, newTitle})
